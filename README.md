...
| # | Tool | Topic | Philosopher(s) | Folder |
|---|------|-------|---|---|
| 1 | **Neurons** | Additive vs Divisive vs Hybrid neurons | Plato · Aristotle · Leibniz | [`neurons`](./neurons) |
| 2 | **ReLU** | Linear vs ReLU vs Sigmoid activations | Parmenides · Heraclitus · Aristotle | [`relu`](./relu) |
| 3 | **Vanishing Gradient** | Why deep networks stopped learning | Zeno · Heraclitus · Aristotle | [`vanishing_gradient`](./vanishing_gradient) |
| 4 | **Paradigms** | 5 thinking paradigms solve one problem | Parmenides · Aristotle · Leibniz · Hume · Epicurus | [`paradigms`](./paradigms) |
| 5 | **Δεν Ξέρω** | Why AI doesn't know it doesn't know | Socrates | [`den_xero`](./den_xero) |
| 6 | **Associationism** | Aristotle's 4 laws of memory → ML | Aristotle | [`associationism`](./associationism) |
...
Each folder contains a single HTML file. Open it in any browser — that's it. No build step, no server, no dependencies.

```bash
# For example:
open neurons/neurons_experiment.html
# or
open relu/relu_experiment.html
```
